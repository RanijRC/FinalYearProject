...
using Constants = CRMS.ServerLibrary.Helpers.Constants;

namespace CRMS.ServerLibrary.Repositories.Implementation
{
    public class UserAccountRepository(IOptions<JwtSection> config, AppDbContext appDbContext) : IUserAccount
    {
        ...
        public async Task<LoginResponse> RefreshTokenAsync(RefreshToken token)
        {
            ...
            if (user is null) return new LoginResponse(false, "Refresh Token could not be genereated as user was not found");
            ...
            if (updateRefreshToken is null) return new LoginResponse(false, "Refresh Token could not be generated as user has not signed in");
